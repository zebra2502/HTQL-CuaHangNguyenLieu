...
namespace QuanLyBanHang.Class{
    class Functions{
        ...
        #endregion
        #region Chuyển định dạng ngày tháng
        public static string ConvertDateTime(string date)
        {
            string[] elements = date.Split('/');
            string dt;
            dt = string.Format("{0}/{1}/{2}", elements[1], elements[0], elements[2]);
            return dt;
        }
        #endregion
        ...
        #endregion
        #region Lấy dữ liệu của các trường
        ...
        #endregion
        #region Chuyển đổi từ PM sang dạng 24h
