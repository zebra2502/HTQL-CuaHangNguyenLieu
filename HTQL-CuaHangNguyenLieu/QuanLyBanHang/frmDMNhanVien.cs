...
namespace QuanLyBanHang
{
    ...
    {
        public DataTable tblNV; //Lưu dữ liệu bảng nhân viên
        ...
        private void dgvNhanVien_CellClick(object sender, EventArgs e)
        {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblNhanVien(MaNhanVien,TenNhanVien,GioiTinh, DiaChi,DienThoai, NgaySinh) VALUES (N'" 
                + txtMaNhanVien.Text.Trim() + "',N'" + txtTenNhanVien.Text.Trim() 
                + "',N'" + gt + "',N'" + txtDiaChi.Text.Trim() + "','" 
                + mtbDienThoai.Text + "','" 
                + Functions.ConvertDateTime(dtpNgaySinh.Text) + "')";
